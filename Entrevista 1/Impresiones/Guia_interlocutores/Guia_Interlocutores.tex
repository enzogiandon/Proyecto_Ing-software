...
\fancyhead[L]{\small\textbf{UNLP --- Facultad de Ingeniería} \textbar\ Ingeniería de Software 2026 \textbar\ Grupo 7}
...
\begin{tabularx}{\textwidth}{@{}X r@{}}
  ...
  \textit{Proyecto de Software: Plataforma de Logística y Reparto} & \small Moderación \& Timekeeper \\
\end{tabularx}
\vspace{1pt}
\hrule height 1.1pt
\vspace{4pt}
...
\small
$\bullet$ Mantener la conversación en tono profesional, empático y fluido. \quad
$\bullet$ Si el entrevistado se desvía, reencauzar amablemente: \textit{``Super claro Martín; y en cuanto a...''}. \quad
$\bullet$ No discutir soluciones de código ni bases de datos; concentrarse 100\% en el problema y procesos de negocio.
\end{tabularx}
